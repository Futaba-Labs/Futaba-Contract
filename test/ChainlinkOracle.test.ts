...
before(async function () {
  ...
  chainlinkLightClientMock = await ChainlinkLightClient.deploy(chainlinkOracle.address, aggregatorV3Mock.address, gasData.gasLimit, gasData.gasPrice, gasData.gasPerQuery)
